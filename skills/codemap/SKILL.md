---
name: codemap
description: Generate a deterministic PlantUML map + snapshot report of a project using static analysis (no LLM) — module shapes, seams, dead code, untested code, redundancy, configs, docs. Use when the user wants a fast codebase snapshot, a dependency/architecture diagram, to spot dead or untested or redundant code, to understand an unfamiliar repo, or to diff structure before vs after a change.
---
...
- For deeper, opinionated refactoring proposals against domain language + ADRs, file a dedicated task or ADR.
