...
#
# Canonical + live copy: cron runs this file directly
# (/home/aaron/repos/arc-skills/bin/nightly-self-improve.sh).
set -uo pipefail
...
GAPS="${GAPS:-$HOME/repos/arc-skills/bin/extract-agent-gaps.py}"
